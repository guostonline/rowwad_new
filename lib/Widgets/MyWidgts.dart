...
Widget myButtonRaisen(context, String text, int reponce) {
  GetXFunctions _controller = Get.put(GetXFunctions());
  return Obx(
    () => AnimatedOpacity(
      opacity: _controller.buttonsCheker(reponce).value,
      ...
      child: Container(
        ...
        child: RaisedButton(
            ...
            onPressed: () {
              _controller.buttonsVisibility(reponce);
              _controller.checkFuction(context, reponce);
            }),
      ),
    ),
  );
